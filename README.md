...
### Controlled distances experiment

* Comparison of the performance of CONSULT with other tools such as Kraken-II, CLARK, CLARK-S and Bowtie performed using TOL query set searched against TOL database.
